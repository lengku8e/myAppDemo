...
import com.example.reflectdemo.reflect.RefInvoke;
...
//            gDefaultField.setAccessible(true);
//            Object gDefault = gDefaultField.get(null); // 取出静态字段
            Object gDefault = RefInvoke.getFieldObject("com.example.reflectdemo.AMN", null , "gDefault");

            // 取出单例中一个字段 AMN的gDefault对象里面原始的 B2对象
//            Class<?> singleton = Class.forName("com.example.reflectdemo.Singleton");
//            Field mInstanceField = singleton.getDeclaredField("mInstance");
//            mInstanceField.setAccessible(true);
//            Object rawB2Object = mInstanceField.get(gDefault);
            Object rawB2Object = RefInvoke
                    .getFieldObject("com.example.reflectdemo.Singleton", gDefault, "mInstance");
            ...
            RefInvoke.setFiledObject("com.example.reflectdemo.Singleton",
